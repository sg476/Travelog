                ...
                <header className="masthead book-page" id="page-top">
                    <div className="container d-flex h-100 align-items-center">
                        <div className="mx-auto text-center">
                            <h1 className="mx-auto my-0 text-uppercase">Travelog</h1>
                            ...
                            <form>
                                <div className="form-inline d-flex form-group">
                                    <input
                                        ...
                                        id="continent"
                                        placeholder="Where?" />&nbsp;
                                <button className="btn btn-dark mx-auto form-control" style={{ height: "64px" }} onClick={this.getPackages}>Search</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8 mx-auto">
                                ...
                                At <Link to="/">Travelog</Link>, we take care of all the requirements to ensure that you get to enjoy the best of your holiday, exploring and experiencing the destination.</p>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50">Vidisha, Madhya Pradesh</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50"><Link to="/home">sid.gupta476@gmail.com</Link></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50">+91-XXXXXXXXXX</div>
                                    </div>
                                </div>
                            </div>
                        </div>
